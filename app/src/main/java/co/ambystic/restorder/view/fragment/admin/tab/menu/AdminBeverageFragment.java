...
public class AdminBeverageFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private static final String TAG = AdminBeverageFragment.class.getSimpleName();

    private RecyclerFoodAdminAdapter recyclerBeverageAdminAdapter;
    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView rvFoodAdmin;
    private FloatingActionButton fabAddBeverage;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_admin_beverage, container, false);
    ...
    private void onButtonClicked() {
        fabAddBeverage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getContext(), AddMenuActivity.class);
                i.putExtra("menuKind", "2");
                startActivity(i);
            }
        });
    }
            ...
            public void onResponse(@NonNull Call<MenuResponse> call, @NonNull Response<MenuResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (response.body().getServerResponse().isError()) {
                        ...
                        recyclerBeverageAdminAdapter = new RecyclerFoodAdminAdapter(getContext(), menuData);

                        rvFoodAdmin.setAdapter(recyclerBeverageAdminAdapter);
                    }
                } else {
    ...
    private void initLayout(View view) {
        rvFoodAdmin = view.findViewById(R.id.rvBeverageAdmin);
        fabAddBeverage = view.findViewById(R.id.fabAddBeverage);
