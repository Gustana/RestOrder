...
public class BeverageOrderFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private RecyclerView rvFoodBeverageList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_beverage_order, container, false);
        ...
        rvFoodBeverageList.setLayoutManager(new LinearLayoutManager(getContext()));
    ...
    private void initLayout(View view) {
        ...
        rvFoodBeverageList = view.findViewById(R.id.rvFoodBeverageList);
    }
            ...
            public void onResponse(@NonNull Call<MenuResponse> call, @NonNull Response<MenuResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (response.body().getServerResponse().isError()) {
                        ...
                        rvFoodBeverageList.setAdapter(recyclerFoodOrderAdminAdapter);
                    }
                } else {
